...
def _calculate_spkd_rust(cspks: np.ndarray | list, qvals: list | np.ndarray) -> np.ndarray: 
    """
...
def _calculate_spkd_python(cspks: np.ndarray | list, qvals: list | np.ndarray) -> np.ndarray:
    """
        Internal function to compute pairwise spike train distances with variable time precision for multiple cost values.
